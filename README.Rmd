...
Es la libreria por escelencia de Python de computacion, contiene entre otras:

  * Arrays objects
  * Funciones para manipular arrays
  * Algebra lineal, generación de numeros aleatorios...

Conocer esta libreria es **fundamental** para trabajar con **Spark**
...
Pandas provee a Python de estructuras rapidas y flexibles, diseñadas para trabajar con datos relacionales facil e intuitivamente
